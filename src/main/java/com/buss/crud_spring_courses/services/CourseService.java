...
public class CourseService {
    ...
    public Optional<Course> findCourseById(@PathVariable @NotNull @Positive Long id) {
    ...
    public Optional<Course> updateCourse(@NotNull @Positive Long id, @Valid Course course) {
        return courseRepository.findById(id)
                .map(courseFound -> {
    ...
    public boolean deleteCourse(@PathVariable @NotNull @Positive Long id) {
        return courseRepository.findById(id)
                .map(courseFound -> {
